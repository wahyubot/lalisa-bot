...
//
const BotName = 'WAHYUBOTS'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/psicyo.lv'; // Nama Instagramlu cok
const whatsapplu = '0823-2375-5174'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @wahyugans`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @wahyugans`)
})
...
conn.sendMessage(id, 'P Autis, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
else if (text == 'P'){
...
conn.sendMessage(id, 'Hai?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
else if (text == 'woi'){
conn.sendMessage(id, 'Apaan Tod?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
else if (text == 'woy'){
conn.sendMessage(id, 'Apaan Tod?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya gan?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
else if (text == 'sis'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
...
conn.sendMessage(id, 'Iyaa Sayang?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
else if (text == 'i love u'){
conn.sendMessage(id, 'love you too' ,MessageType.text);
}
else if (text == 'mas'){
conn.sendMessage(id, 'Dalem?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
else if (text == 'mba'){
conn.sendMessage(id, 'Dalem?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
