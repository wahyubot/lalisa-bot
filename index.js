...
*/
const A187 = 'LALISA BOTS'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' *Owner   wa.me/+6282323755174* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator   wa.me/+6282323755174* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, ' _Thanks Telah Menggunakan BOT *LALISA BOTS* , Follow IG OWNER Yah� : https://instagram.com/psicyo.lv_',MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _Thanks Telah Menggunakan BOT *LALISA BOTS* , Follow IG OWNER Yah� : https://instagram.com/psicyo.lv_' ,MessageType.text);
}
