...
const groupwhatsapp = 'Nggak Ada'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'Nggak Ada'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.sendMessage(id, ' _P juga bro...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, ' _P juga bro...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'Halo'){
conn.sendMessage(id, ' _Halo kk...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'Asu'){
conn.sendMessage(id, 'Lu Asw' ,MessageType.text);
}
else if (text == '#owner'){
conn.sendMessage(id, ' *Owner WAHYU BOTS https://wa.me/+6282323755174* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator WAHYU BOTS wa.me/+6282323755174* ' ,MessageType.text);
}
else if (text == 'Pagi'){
conn.sendMessage(id, ' _Pagi juga kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'Siang'){
conn.sendMessage(id, ' _Siang juga kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'Sore'){
conn.sendMessage(id, ' _Sore juga kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'Malam'){
conn.sendMessage(id, ' _Malam juga kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _hai kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Iyah sayangku...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'I love u'){
conn.sendMessage(id, ' _love you too😻_ ' ,MessageType.text);
}
else if (text == 'Mas'){
conn.sendMessage(id, ' _Iyaa dede...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'Mba'){
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾WAHYUBOTS👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/psicyo.lv_' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾WAHYUBOTS👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/psicyo.lv_' ,MessageType.text);
}
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾WAHYUBOTA👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/psicyo.lv_' ,MessageType.text);
}
else if (text == '#menu4'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾WAHYUBOTS👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/psicyo.lv_' ,MessageType.text);
}
