...
Thanks To L4LISA for share script🛡
```bash
...
```
### Cara Installnya
Script ini di modifikasi sama saya sendiri L4LISA-BOT.
```bash
...
> jika udah ketik di nodejs nya cd C:\lalisa-bot-main
> npm i ytdl
> npm i cwebp
> npm i
> npm i got
> node index.js
```
### masih sebagaian fitur masih ada bug
```php
